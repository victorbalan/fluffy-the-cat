function Player(startPos, stage){
	...
	return {
		getBounds: function(){ return player.getBounds(); },
		setBounds: function(x, y, width, height){ player.setBounds(x, y, width, height); player.x = x; player.y = y; },
		getPlayerDimension: function(){ return playerDimension; }
	}
}
